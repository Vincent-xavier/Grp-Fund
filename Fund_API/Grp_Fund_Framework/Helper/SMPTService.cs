...
namespace Fund_API.Framework.Helper
{
    ...
    {
        public static ConfSettings Settings = new();
        ...
        public static string FormatMailContent(string mailContent)
        {
            ...
            string ApplicationLogo = Settings.SMTPMailConfig.LogoUrl;
